...
SECRET_KEY = 'django-insecure-2#!v_ncnln%id65yz!)dpw2t*136ezrnqhakd)v^3-^64fij9@'
...
REST_FRAMEWORK = {
   'DEFAULT_AUTHENTICATION_CLASSES': (
       'rest_framework_simplejwt.authentication.JWTAuthentication',
        'rest_framework.authentication.SessionAuthentication', # после добавления заработал вход
        'rest_framework.authentication.BasicAuthentication',# после добавления заработал вход
   ),
...
# CSRF_TRUSTED_ORIGINS = ['http://127.0.0.1:8000']  # Для разработки
